...
const CartComponent = {
    props: ['id', 'title', 'qty', 'price', 'cartdropmenuimg'],
    template: `<div class="product-in-sc">
                                <a href="single-page.htm" style="float: left; width: 240px;">
                                    <div class="product-in-sc-img" :style="cartdropmenuimg">
                                    </div>
    ...
    template: `<div class="sh"><a href="shopping-card.htm"><img src="img/Forma_1.svg" alt="basket"
                        ...
                        <div class="shopping-cart__drop">
                            <cart-component v-for="item in items"
                              ...
                              :qty="item.qty"
                              :price="item.price"
                              :cartdropmenuimg="item.cartdropmenuimg">
                            </cart-component>
                            <div class="total">
                                <div>total</div>
                                <div>$500.00</div>
...
const scRoot = new Vue({
    ...
    components: {
        ...
        'cart-page-list-component': CartPageListComponent
    },
});
